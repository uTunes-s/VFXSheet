...
export function getSavedCameras() {
  return state.cameraListState.map(camera => ({
    ...
    cramerawork_is_custom: camera.cramerawork_preset === '__custom__',
