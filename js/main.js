...
const CLASSIC_ASSETS = [
  ...
  './canvas-history.js', './canvas-style.js', './canvas-mode.js', './canvas-images.js', './record-modal.js', './record-save.js', './record-load.js', './thumbnail-collage.js', './zip-utils.js', './shooting-data-pdf.js', './flowpt-export.js', './backup.js', './sync.js', './canvas-eraser.js', './canvas-core.js', './canvas-crop.js',
