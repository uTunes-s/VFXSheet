...
const CLASSIC_ASSETS = [
  ...
  './canvas-history.js', './canvas-mode.js', './canvas-images.js', './thumbnail-collage.js', './zip-utils.js', './shooting-data-pdf.js', './flowpt-export.js', './backup.js', './sync.js', './canvas-eraser.js', './canvas-core.js', './canvas-crop.js',
