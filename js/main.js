...
const CLASSIC_ASSETS = [
  ...
  './state.js', './default-settings.js', './form-ui.js', './shot-thumbnails.js', './gps.js',
  './preset-normalizers.js', './preset-store.js', './preset-actions.js', './preset-modal.js', './media-modals.js', './record-thumbnails.js', './camera-model.js', './camera-tabs-state.js', './camera-tabs-interactions.js', './preset-options.js',
...
for (const source of CLASSIC_ASSETS) {
  await loadClassicScript(source);
  if (source === './state.js') await import('./database.js');
}
