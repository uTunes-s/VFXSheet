...
const CLASSIC_ASSETS = [
  ...
  './preset-actions.js', './preset-modal.js', './media-modals.js', './record-thumbnails.js', './camera-model.js', './camera-tabs-state.js', './camera-tabs-interactions.js', './preset-options.js',
